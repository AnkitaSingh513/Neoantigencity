...
gene_data <- read.csv("/home/Ankita.Singh/Desktop/NEOANTIGEN/Results/breast_cancer_gene_summary_updated.csv")
...
write.csv(merged_data, "/home/Ankita.Singh/Desktop/NEOANTIGEN/Results/breast_cancer_gene_summary_updated_with_GO_and_locations.csv", row.names = FALSE)
