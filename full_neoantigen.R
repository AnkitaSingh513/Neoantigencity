...
setwd("/home/Ankita.Singh/Desktop/NEOANTIGEN/")

# Step 1: Load the MAF file (mutation data)
maf_file <- "/home/Ankita.Singh/Desktop/NEOANTIGEN/Data/Others/mc3.v0.2.8.PUBLIC.maf.gz"
maf_data <- read.maf(maf = maf_file)

# Step 2: Load the GDC sample file
gdc_file <- "/home/Ankita.Singh/Desktop/NEOANTIGEN/neoantigent/GDC-PANCAN.basic_phenotype.tsv"
...
breast_cancer_gene_summary <- gene_summary_per_cancer[gene_summary_per_cancer$project_id=="TCGA-BRCA",] %>% data.frame()
...
write.csv(breast_cancer_gene_summary, "breast_cancer_gene_summary_updated.csv", row.names = FALSE)
